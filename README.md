...
| Splash | Loading | Success | Empty | Error |
|---|---|---|---|---|
| ![Splash](docs/screenshots/splash.png) | ![Loading](docs/screenshots/loading.png) | ![Success](docs/screenshots/success.png) | ![Empty](docs/screenshots/empty.png) | ![Error](docs/screenshots/error.png) |
